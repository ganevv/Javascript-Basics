function newHouse(input) {
    ...
    if (budget >= moneyForAllFlowers) {
        console.log(`Hey, you have a great garden with ${flowersCount} ${flowerType} and ${(budget - moneyForAllFlowers).toFixed(2)} leva left.`)
    } else {
        console.log(`Not enough money, you need ${(moneyForAllFlowers - budget).toFixed(2)} leva more.`)
    }
}
